...
const ALG_SETS = {
  ...
  PLL: [{ name: "Aa", alg: "l' U R' D2 R U' R' D2 R2 x'" }, { name: "Ab", alg: "l' R' D2 R U R' D2 R U' R x'" }, { name: "E", alg: "y x' R U' R' D R U R' D' R U R' D R U' R' D' x" }, { name: "F", alg: "y R' U' F' R U R' U' R' F R2 U' R' U' R U R' U R" }, { name: "Ga", alg: "R2 u R' U R' U' R u' R2 y' R' U R" }, { name: "Gb", alg: "R' U' R U D' R2 U R' U R U' R U' R2 D" }, { name: "Gc", alg: "y2 R2 F2 R U2 R U2 R' F R U R' U' R' F R2" }, { name: "Gd", alg: "R U R' U' D R2 U' R U' R' U R' U R2 D'" }, { name: "H", alg: "M2 U' M2 U2 M2 U' M2" }, { name: "Ja", alg: "L' U2 L U L' U2 R U' L U R'" }, { name: "Jb", alg: "R U R' F' R U R' U' R' F R2 U' R'" }, { name: "Na", alg: "R U R' U R U R' F' R U R' U' R' F R2 U' R' U2 R U' R'" }, { name: "Nb", alg: "R' U L' U2 R U' L R' U L' U2 R U' L" }, { name: "Ra", alg: "y2 R U2 R' U2 R B' R' U' R U R B R2" }, { name: "Rb", alg: "R' U2 R U2 R' F R U R' U' R' F' R2" }, { name: "T", alg: "R U R' U' R' F R2 U' R' U' R U R' F'" }, { name: "Ua", alg: "y2 R U' R U R U R U' R' U' R2" }, { name: "Ub", alg: "y2 R2 U R U R' U' R' U' R' U R'" }, { name: "V", alg: "z D' R2 D R2 U R' D' R U' R U R' D R U'" }, { name: "Y", alg: "F R U' R' U' R U R' F' R U R' U' R' F R F'" }, { name: "Z", alg: "M2 U' M2 U' M' U2 M2 U2 M'" }],
  TEST: [{name: "AA", alg: "y x R2 r L x z L' r2 U F B l' x'"}, {name: "MM", alg: "R U R' U' M' U R U' r'"}, {name: "AB", alg: "u R2 r L x z L' r2 U F B l' x'"},  {name: "AC", alg: "y x R2 x x z x2 x' x'"}, {name: "test", alg: "R y x"}, {name: "test", alg: "x y R"}, {name: "test", alg: "x y z R"},  {name: "test", alg: "y' R y'"}, {name: "test", alg: "x' R x'"}, {name: "test", alg: "z' R z'"},  {name: "test", alg: "y x R x"}, {name: "test", alg: "x R"}, {name: "test", alg: "z R"}],
}
...
// TODO: saving progress in sequential selector
